...
object RetrofitClient {
    ...
    fun getTmdbClient(): com.hasanege.materialtv.network.tmdb.TmdbApiService {
        val retrofit = Retrofit.Builder()
            .baseUrl("https://api.themoviedb.org/3/")
            .client(unsafeOkHttpClient)
            .addConverterFactory(json.asConverterFactory("application/json".toMediaType()))
            .build()
        return retrofit.create(com.hasanege.materialtv.network.tmdb.TmdbApiService::class.java)
    }

    fun getSkipDbClient(): com.hasanege.materialtv.network.skipdb.SkipDbApiService {
        val retrofit = Retrofit.Builder()
            .baseUrl("https://api.skipdb.tv/")
            .client(unsafeOkHttpClient)
            .addConverterFactory(json.asConverterFactory("application/json".toMediaType()))
            .build()
        return retrofit.create(com.hasanege.materialtv.network.skipdb.SkipDbApiService::class.java)
    }

    fun getOpenSubtitlesClient(): com.hasanege.materialtv.network.opensubtitles.OpenSubtitlesApiService {
        val retrofit = Retrofit.Builder()
            .baseUrl("https://api.opensubtitles.com/")
            .client(unsafeOkHttpClient)
            .addConverterFactory(json.asConverterFactory("application/json".toMediaType()))
            .build()
        return retrofit.create(com.hasanege.materialtv.network.opensubtitles.OpenSubtitlesApiService::class.java)
    }
}
