...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideTmdbApiService(): com.hasanege.materialtv.network.tmdb.TmdbApiService {
        return com.hasanege.materialtv.network.RetrofitClient.getTmdbClient()
    }

    @Provides
    @Singleton
    fun provideTmdbDao(database: com.hasanege.materialtv.data.AppDatabase): com.hasanege.materialtv.data.dao.TmdbDao {
        return database.tmdbDao()
    }

    @Provides
    @Singleton
    fun provideSkipDbApiService(): com.hasanege.materialtv.network.skipdb.SkipDbApiService {
        return com.hasanege.materialtv.network.RetrofitClient.getSkipDbClient()
    }

    @Provides
    @Singleton
    fun provideOkHttpClient(): okhttp3.OkHttpClient {
        return com.hasanege.materialtv.network.RetrofitClient.unsafeOkHttpClient
    }

    @Provides
    @Singleton
    fun provideOpenSubtitlesApiService(): com.hasanege.materialtv.network.opensubtitles.OpenSubtitlesApiService {
        return com.hasanege.materialtv.network.RetrofitClient.getOpenSubtitlesClient()
    }
}
